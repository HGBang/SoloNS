...
#include "NSAbility_Cleric_GuidingBolt.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Cleric_GuidingBolt : public UNSAbility_Cleric_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Cleric_GuidingBolt();
