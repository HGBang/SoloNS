...
#include "NSAbility_Dragon_ScratchAttack.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Dragon_ScratchAttack : public UNSGameAbility
{
	GENERATED_BODY()

public:
	UNSAbility_Dragon_ScratchAttack();
