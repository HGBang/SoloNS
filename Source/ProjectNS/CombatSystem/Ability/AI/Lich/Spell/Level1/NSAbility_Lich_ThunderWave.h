...
#include "NSAbility_Lich_ThunderWave.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Lich_ThunderWave : public UNSAbility_Lich_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Lich_ThunderWave();
