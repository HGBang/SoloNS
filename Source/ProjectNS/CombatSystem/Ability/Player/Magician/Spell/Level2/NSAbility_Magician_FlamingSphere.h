...
#include "NSAbility_Magician_FlamingSphere.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Magician_FlamingSphere : public UNSAbility_Magician_SpellBase
{
	GENERATED_BODY()
	
public:
	UNSAbility_Magician_FlamingSphere();
