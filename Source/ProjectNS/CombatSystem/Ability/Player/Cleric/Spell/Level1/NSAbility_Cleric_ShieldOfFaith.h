...
#include "NSAbility_Cleric_ShieldOfFaith.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Cleric_ShieldOfFaith : public UNSAbility_Cleric_SpellBase
{
	GENERATED_BODY()
	
public:
	UNSAbility_Cleric_ShieldOfFaith();
