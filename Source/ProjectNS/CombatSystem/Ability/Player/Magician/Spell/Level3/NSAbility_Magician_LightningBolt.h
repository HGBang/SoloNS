...
#include "NSAbility_Magician_LightningBolt.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Magician_LightningBolt : public UNSAbility_Magician_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Magician_LightningBolt();
