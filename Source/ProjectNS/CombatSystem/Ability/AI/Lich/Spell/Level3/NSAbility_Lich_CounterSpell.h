...
#include "NSAbility_Lich_CounterSpell.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Lich_CounterSpell : public UNSAbility_Lich_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Lich_CounterSpell();
