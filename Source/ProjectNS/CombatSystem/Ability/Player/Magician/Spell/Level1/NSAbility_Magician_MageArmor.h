...
#include "NSAbility_Magician_MageArmor.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Magician_MageArmor : public UNSAbility_Magician_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Magician_MageArmor();
