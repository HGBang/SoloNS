...
#include "NSAbility_Magician_Levitate.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Magician_Levitate : public UNSAbility_Magician_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Magician_Levitate();
