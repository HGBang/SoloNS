...
#include "NSAbility_Cleric_InflictWounds.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Cleric_InflictWounds : public UNSAbility_Cleric_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Cleric_InflictWounds();
