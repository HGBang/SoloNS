...
#include "NSAbility_Skeleton_MeleeAttack.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Skeleton_MeleeAttack : public UNSGameAbility
{
	GENERATED_BODY()

public:
	UNSAbility_Skeleton_MeleeAttack();
