...
#include "NSMagicianAttributeSet.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSMagicianAttributeSet : public UNSCharacterAttributeSet
{
	GENERATED_BODY()

public:
	UNSMagicianAttributeSet();

protected:
	UPROPERTY(Category = "NS|Attribute", EditAnywhere, BlueprintReadOnly, Replicated)
	FAttribute	MagicDamage;
