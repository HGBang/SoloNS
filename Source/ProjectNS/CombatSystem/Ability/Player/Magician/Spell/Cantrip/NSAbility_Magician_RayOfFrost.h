...
#include "NSAbility_Magician_RayOfFrost.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Magician_RayOfFrost : public UNSAbility_Magician_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Magician_RayOfFrost();
