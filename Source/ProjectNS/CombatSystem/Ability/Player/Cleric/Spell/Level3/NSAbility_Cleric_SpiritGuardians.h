...
#include "NSAbility_Cleric_SpiritGuardians.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Cleric_SpiritGuardians : public UNSAbility_Cleric_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Cleric_SpiritGuardians();
