...
#include "../NSAbility_Cleric_ChannelDivinity.h"
#include "NSAbility_Cleric_PreserveLife.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Cleric_PreserveLife : public UNSAbility_Cleric_ChannelDivinity
{
	GENERATED_BODY()

public:
	UNSAbility_Cleric_PreserveLife();
