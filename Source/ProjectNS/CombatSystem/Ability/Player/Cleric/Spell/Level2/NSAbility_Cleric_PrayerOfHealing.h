...
#include "NSAbility_Cleric_PrayerOfHealing.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Cleric_PrayerOfHealing : public UNSAbility_Cleric_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Cleric_PrayerOfHealing();
