...
#include "NSAbility_Lich_LightningBolt.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Lich_LightningBolt : public UNSAbility_Lich_SpellBase
{
	GENERATED_BODY()
	
public:
	UNSAbility_Lich_LightningBolt();
