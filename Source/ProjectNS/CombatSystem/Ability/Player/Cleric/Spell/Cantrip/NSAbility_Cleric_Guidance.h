...
#include "NSAbility_Cleric_Guidance.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Cleric_Guidance : public UNSAbility_Cleric_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Cleric_Guidance();
