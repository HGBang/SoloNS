...
#include "NSAbility_Cleric_Resistance.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Cleric_Resistance : public UNSAbility_Cleric_SpellBase
{
	GENERATED_BODY()
	
public:
	UNSAbility_Cleric_Resistance();
