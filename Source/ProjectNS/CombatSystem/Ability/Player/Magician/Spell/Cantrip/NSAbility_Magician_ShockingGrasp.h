...
#include "NSAbility_Magician_ShockingGrasp.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Magician_ShockingGrasp : public UNSAbility_Magician_SpellBase
{
	GENERATED_BODY()
	
public:
	UNSAbility_Magician_ShockingGrasp();
