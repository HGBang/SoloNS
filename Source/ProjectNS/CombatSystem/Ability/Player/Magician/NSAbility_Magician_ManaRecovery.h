...
#include "NSAbility_Magician_ManaRecovery.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Magician_ManaRecovery : public UNSGameAbility
{
	GENERATED_BODY()

public:
	UNSAbility_Magician_ManaRecovery();
