...
#include "NSAbility_Cleric_TurnUndead.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Cleric_TurnUndead : public UNSAbility_Cleric_ChannelDivinity
{
	GENERATED_BODY()
	
public:
	UNSAbility_Cleric_TurnUndead();
