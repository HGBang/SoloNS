...
#include "NSAbility_Dragon_BreathAttack.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Dragon_BreathAttack : public UNSGameAbility
{
	GENERATED_BODY()

public:
	UNSAbility_Dragon_BreathAttack();
