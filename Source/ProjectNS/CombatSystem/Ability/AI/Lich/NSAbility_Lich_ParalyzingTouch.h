...
#include "NSAbility_Lich_ParalyzingTouch.generated.h"

/**
 * Cave Lich Melee Atack
 */
UCLASS()
class PROJECTNS_API UNSAbility_Lich_ParalyzingTouch : public UNSGameAbility
{
	GENERATED_BODY()

public:
	UNSAbility_Lich_ParalyzingTouch();
