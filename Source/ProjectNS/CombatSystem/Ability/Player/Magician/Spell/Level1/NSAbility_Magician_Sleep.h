...
#include "NSAbility_Magician_Sleep.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Magician_Sleep : public UNSAbility_Magician_SpellBase
{
	GENERATED_BODY()

public:
	UNSAbility_Magician_Sleep();
