...
#include "NSAbility_Magician_MagicMissile.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Magician_MagicMissile : public UNSAbility_Magician_SpellBase
{
	GENERATED_BODY()
	
public:
	UNSAbility_Magician_MagicMissile();
