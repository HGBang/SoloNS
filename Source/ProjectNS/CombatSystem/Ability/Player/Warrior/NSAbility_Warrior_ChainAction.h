...
#include "NSAbility_Warrior_ChainAction.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTNS_API UNSAbility_Warrior_ChainAction : public UNSGameAbility
{
	GENERATED_BODY()

public:
	UNSAbility_Warrior_ChainAction();
